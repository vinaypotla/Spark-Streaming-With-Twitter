...
import streaming.SentimentAnalyzer.mainSentiment
...
object TwitterProducer {
  def main(args: Array[String]) {
    ...
    System.setProperty("twitter4j.oauth.consumerKey", "lvpon7nYrWbGPYYkwlsOqT6sj")
    System.setProperty("twitter4j.oauth.consumerSecret", "vWnyAn9vxIPmQUAX8mSBnqL3B7JadSdGUwlgDuG0Mh9fhza0Sz")
    System.setProperty("twitter4j.oauth.accessToken", "1019738231938736129-EtLfc1RT8sXiv0ZvE61gVBcUWyWcXV")
    System.setProperty("twitter4j.oauth.accessTokenSecret", "Mpmq3qPxKlfM5OrOiYuphyIaW0NVVTak2RtO7zBUC1Wzh")
